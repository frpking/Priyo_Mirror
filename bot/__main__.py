...
def start(update, context):
    ...
    buttons.buildbutton("⚙️ Repo", "https://github.com/itspriyo/Priyo_Mirror")
    buttons.buildbutton("👥 Support Group", "https://t.me/joinchat/jljHMPs11ck5NGU9")
    reply_markup = InlineKeyboardMarkup(buttons.build_menu(2))
    if CustomFilters.authorized_user(update) or CustomFilters.authorized_chat(update):
        start_string = f'''
This bot can mirror all your links to Google Drive! Modified By @itspriyo.
...
help = Telegraph(access_token=telegraph_token).create_page(
        title='Priyo Mirror Help',
        author_name='Priyo Mirror',
